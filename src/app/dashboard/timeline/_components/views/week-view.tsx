...
import { format, addDays, startOfWeek, isSameDay, addMinutes, startOfDay, isToday } from "date-fns";
      ...
      <div className="flex border-b">
        ...
        <div className="grid grid-cols-7 flex-1 divide-x">
          {weekDays.map((day, index) => {
            const dayAllDayEvents = dummyEvents.filter(event => 
      ...
      <div className="flex border-b sticky top-0 bg-background z-20">
        ...
        {weekDays.map((day, index) => (
          ...
          >
            ...
            <div className={cn(
              "text-sm",
              isToday(day) ? "text-red-500 font-bold" : "text-muted-foreground"
            )}>
              {format(day, 'd')}
            </div>
          </div>
              ...
              return (
                <div
                  ...
                  style={{
                    top: `${top}%`,
                    height: `${height}%`,
                    left: `calc(16px + (${dayIndex} * ${columnWidth}%))`,
